...
#good practice to individually define imports:
...
urlpatterns = patterns('',
    # Examples:
    # url(r'^$', 'skillshare_appsuite.views.home', name='home'),
    # url(r'^skillshare_appsuite/', include('skillshare_appsuite.foo.urls')),
